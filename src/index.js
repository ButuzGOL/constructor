...
import Q from './scripts/base/q';
import Abbr from './scripts/base/abbr';
import Dfn from './scripts/base/dfn';
import Small from './scripts/base/small';
import Hr from './scripts/base/hr';
import Blockquote from './scripts/base/blockquote';
import Img from './scripts/base/img';

import List from './scripts/list';
import DescriptionList from './scripts/description-list';
...
export default {
  ...
  Hr, Blockquote, Img,
  List, DescriptionList, Badge, Close, Panel, Block, Article
};
